...
export function LobsterClawIllustration() {
  ...
  if (reducedMotion) {
    return (
      <div className="relative mx-auto h-[250px] w-[250px] sm:h-[330px] sm:w-[330px]" aria-label="V50 logo emblem">
        ...
        <div className="absolute inset-[10px] overflow-hidden rounded-full border border-[#d7d0c2] bg-white/80">
          <Image src="/v50-logo.png" alt="V50 logo" fill sizes="(max-width: 640px) 250px, 330px" className="object-cover" />
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="relative mx-auto h-[250px] w-[250px] sm:h-[330px] sm:w-[330px]" aria-label="Animated V50 logo emblem">
      <motion.div
